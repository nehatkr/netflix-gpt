    ...
    return (
      <div className="px-2 sm:px-4 md:px-6 py-4">
        ...
        <div className="flex gap-3 sm:gap-4 md:gap-5">
          {[...Array(6)].map((_, index) => (
            <div key={index} className="w-28 sm:w-32 md:w-36 lg:w-48 flex-shrink-0">
  ...
  return (
    <div className="px-2 sm:px-4 md:px-6 py-4 fade-in">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        {/* View all button */}
        <button className="hidden md:flex items-center text-gray-400 hover:text-white transition-colors duration-300 text-sm group slide-in-right">
